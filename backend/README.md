...
## Project Structure
    ...
    ├── collectible_distro__36590  # Django project configurations
...
1. Clone this repo and `cd collectible_distro__36590`
...
2. Clone this repo and `cd collectible_distro__36590`
